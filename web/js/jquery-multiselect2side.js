			...
			var htmlToAdd = 
				"<div class='ms2side__div'>" +
					...
					"<div class='ms2side__options'>" +
						...
						?
						("<p class='AddOne' title='Add Selected'><span class='glyphicon glyphicon-chevron-right'><span></p>" +
						"<p class='AddAll' title='Add All'><span class='glyphicon glyphicon-forward'><span></p>" +
						"<p class='RemoveOne' title='Remove Selected'><span class='glyphicon glyphicon-chevron-left'><span></p>" +
						"<p class='RemoveAll' title='Remove All'><span class='glyphicon glyphicon-backward'><span></p>")
						:
						("<p class='AddOne' title='Add Selected'><span class='glyphicon glyphicon-chevron-left'><span></p>" +
						"<p class='AddAll' title='Add All'><span class='glyphicon glyphicon-backward'><span></p>" +
						"<p class='RemoveOne' title='Remove Selected'><span class='glyphicon glyphicon-chevron-right'><span></p>" +
						"<p class='RemoveAll' title='Remove All'><span class='glyphicon glyphicon-forward'><span></p>")
						) +
					"</div>" +
					"<div class='ms2side__select'>" +
